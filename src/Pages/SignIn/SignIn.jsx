    ...
    return (
        <div className='lg:flex gap-[70px] justify-between items-center max-w-[1240px] mx-auto '>
            ...
            <div className="w-1/2 max-w-md p-[75px] space-y-3 rounded-xl border border-gray-300  bg-white dark:bg-gray-900 text-black dark:text-gray-800">
                <h1 className="text-[40px] font-bold text-center">SignIn</h1>
                <form onSubmit={handleSinIn} className="space-y-6">
                    ...
                    <button className="block w-full p-3 text-center rounded-sm text-gray-900 dark:text-gray-50 bg-[#FF3811] dark:bg-[#FF3811]">Sign in</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400 dark:text-gray-600">Don't have an account?
                    <Link to='/signUp' className="underline text-[#FF3811] dark:text-gray-800">Sign up</Link>
                </p>
            </div>
        </div>
    );
